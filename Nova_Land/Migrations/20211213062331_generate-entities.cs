    ...
    public partial class generateentities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LocationProduct", x => new { x.LocationsId, x.ProductsId });
                    table.ForeignKey(
                        name: "FK_LocationProduct_Locations_LocationsId",
                        column: x => x.LocationsId,
                        principalTable: "Locations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LocationProduct_Products_ProductsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LocationProduct_ProductsId",
